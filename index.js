...
let count1 = parseInt(localStorage.getItem("likeCount")) || 0;
...
likeButton.addEventListener("click", function() {
  ...
  localStorage.setItem("likeCount", count1.toString());
});
    ...
    if (counterElement) {
      ...
      modalContent.innerHTML = `
        <div id="modal-text-container">
          ...
          <!-- Image here -->
          <img src="img/store.jpg" alt="Celebration Image" style="width: 100px; height: 100px;">
        </div>
      `;
